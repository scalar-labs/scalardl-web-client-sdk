...
window.setTimeout(console.log('heloo'), 1000);
// let clientService;
//
const properties = {
...
// const mockedContractName = 'com.scalar.am.contract.ListTypeContract';
const mockedFunctionName = 'com.org1.function.TestFunction';
const mockedArgument = {property: 'foo@example.com'};
// const mockedListTypeContract = new Uint8Array(
//     require('arraybuffer-loader!./ListTypeContract.class'));
const mockedByteFunction = new Uint8Array(
    require('arraybuffer-loader!./TestFunction.class'));
// const property = {holderId: 'foo@example.com'};
...
//   console.log(e);
// });
clientService.registerFunction(mockedFunctionId, mockedFunctionName,
    mockedByteFunction);
...
//         mockedContractName, mockedByteFunction);
//     console.log(response);
//     assert.equal(response.getStatus(), 200);
//   });
// });
